  ...
  <div class="navbar-inner">
	<div class="container">
	  <div class="nav-collapse">
		...
		<ul class="nav">
			<li class=""><a href="adminPlato.php">ADMINISTRAR PEDIDOS</a></li>
		</ul>
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		<h2> Administración de Salones registrados</h2>	
			<div class="row-fluid">
                <div class="well well-small" style="text-align:center">
					<h4 >Agregar salones</h4>
						<a href="crearSalones.php"><small>Agregar</small></a>
					</div>
				</div>	
